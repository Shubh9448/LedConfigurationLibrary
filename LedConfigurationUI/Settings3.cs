...
{
    public partial class Settings3 : Form
    {
        public Settings3()
        {
            InitializeComponent();
        ...
        private void ApplyButton_Click(object sender, EventArgs e)
        {
            ...
            pre_text.Add("4_font");
            pre_text.Add("4_scroll");
            pre_text.Add("4_textcolor");
            pre_text.Add("4_backgroundcolor");
            pre_text.Add("4_W_H");
            //pre_text.Add("Bus Time size");
            //pre_text.Add("Bus Time font type");
            //pre_text.Add("Bus Time font type swap");
            //pre_text.Add("Bus Time swap font type");
            //pre_text.Add("Bus Time font type swap after time");
            //pre_text.Add("Bus Time color RGB foreground");
            //pre_text.Add("Bus Time color RGB background");
            //pre_text.Add("Bus Time Position");
            //pre_text.Add("Bus Time static");
            //pre_text.Add("Bus Time swap");
            //pre_text.Add("Bus Time swap position");
            //pre_text.Add("Bus Time swap position after time");
            //pre_text.Add("Bus Time scroll frequency");
