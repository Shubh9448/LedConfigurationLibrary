...
{
    public partial class Settings4 : Form
    {
        public Settings4()
        {
            InitializeComponent();
        ...
        private void ApplyButton_Click(object sender, EventArgs e)
        {
            ...
            pre_text.Add("Trip Code size");
            pre_text.Add("Trip Code font type");
            pre_text.Add("Trip Code font type swap");
            pre_text.Add("Trip Code swap font type");
            pre_text.Add("Trip Code font type swap after time");
            pre_text.Add("Trip Code color RGB foreground");
            pre_text.Add("Trip Code color RGB background");
            pre_text.Add("Trip Code position");
            pre_text.Add("Trip Code static");
            pre_text.Add("Trip Code swap");
            pre_text.Add("Trip Code swap position");
            pre_text.Add("Trip Code swap position after time");
            pre_text.Add("Trip Code scroll frequency");
