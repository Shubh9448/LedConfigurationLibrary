...
{
    public partial class Settings5 : Form
    {
        public Settings5()
        {
            InitializeComponent();
        ...
        private void ApplyButton_Click(object sender, EventArgs e)
        {
            ...
            pre_text.Add("Source place size");
            pre_text.Add("Source place font type");
            pre_text.Add("Source place font type swap");
            pre_text.Add("Source place swap font type");
            pre_text.Add("Source place font type swap after time");
            pre_text.Add("Source place color RGB foreground");
            pre_text.Add("Source place color RGB background");
            pre_text.Add("Source place position");
            pre_text.Add("Source place static");
            pre_text.Add("Source place swap");
            pre_text.Add("Source place swap position");
            pre_text.Add("Source place swap position after time");
            pre_text.Add("Source place scroll frequency");
